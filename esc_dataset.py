...
edge_path = '/data/zhuoer/ESC/Comet_re/ESC' + '_edge_attr_' + 'train' + '.pkl'
edge_repre = pickle.load(open(edge_path, 'rb'), encoding='utf-8')

class BaseDataset(Dataset):
    def __init__(self, dataset_type, toker: AutoTokenizer):
        ...
        if dataset_type == 'train':
            ...
            graph_path = '/data/zhuoer/ESC/simple_graph/original/train_graph_511_40_8_hip2.pkl'
            edge_path = '/data/zhuoer/ESC/Comet_re/ESC' + '_edge_attr_' + dataset_type + '.pkl'
            problem_path = '/data/zhuoer/ESC/simple_graph/original/train_problem.pkl'
            situation_path = '/data/zhuoer/ESC/simple_graph/original/train_situation.pkl'
        elif dataset_type == 'valid':
            data_path = '/data/zhuoer/ESC/simple_graph/original/valid_511_40_8.pkl'
            graph_path = '/data/zhuoer/ESC/simple_graph/original/valid_graph_511_40_8_hip2.pkl'
            edge_path = '/data/zhuoer/ESC/Comet_re/ESC' + '_edge_attr_' + dataset_type + '.pkl'
            problem_path = '/data/zhuoer/ESC/simple_graph/original/valid_problem.pkl'
            situation_path = '/data/zhuoer/ESC/simple_graph/original/valid_situation.pkl'
        elif dataset_type == 'test':
            data_path = '/data/zhuoer/ESC/simple_graph/original/test_511_40_8.pkl'
            graph_path = '/data/zhuoer/ESC/simple_graph/original/test_graph_511_40_8_hip2.pkl'
            edge_path = '/data/zhuoer/ESC/Comet_re/ESC' + '_edge_attr_' + dataset_type + '.pkl'
            problem_path = '/data/zhuoer/ESC/simple_graph/original/test_problem.pkl'
            situation_path = '/data/zhuoer/ESC/simple_graph/original/test_situation.pkl'
    ...
    def __getitem__(self, item):
        ...
        for i,et in enumerate(edge_type):
            edge_repre.append(self.edge_repre[dia_id][edge_index[0,i]+dia_turn[0]][et])

        p = self.problem[dia_id]
        s = self.situation[dia_id]
