...
trainset = BaseDataset(dataset_type='train',toker=toker)
...
valset = BaseDataset(dataset_type='test',toker=toker)
...
output_dir = join(f'/data/zhuoer/ESC/simple_graph/my_result/',
